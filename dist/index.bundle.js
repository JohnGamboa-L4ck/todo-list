    ...
    div.innerHTML = `
        ...
        <div class = "scheduler">
            <button class = "sched" id = "schedulerTodayBtn">
                <span>Today</span>
                <span id = "schedulerTodaySpan">${_data_js__WEBPACK_IMPORTED_MODULE_1__.dateString.todayName()}</span>
            </button>
            <button class = "sched" id = "schedulerTwmBtn">
                <span>Tomorrow</span>
                <span id = "schedulerTwmBtn">${_data_js__WEBPACK_IMPORTED_MODULE_1__.dateString.tomorrowName()}</span>
            </button>
            <button class = "sched" id = "schedulerNextWeekBtn">
                <span>Next week</span>
                <span id = "schedulerNextWeekSpan">${_data_js__WEBPACK_IMPORTED_MODULE_1__.dateString.nextWeekName()}</span>
            </button>
