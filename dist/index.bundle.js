...
const createContainer = () => {
    ...
    if((0,_data_js__WEBPACK_IMPORTED_MODULE_1__.isEmptyToDayList)()){//fix using dates since it defends on today's data
